...
<body class="all_content">
  <div class="d-flex">
    <div class="sidebar">
      @section('sidebar')
      <p><a href="{{ route('top.show') }}"><img src="{{ asset('image/home.png') }}" width="30px" height="30px">トップ</a></p>
      ...
      <p><a href="{{ route('post.show') }}"><img src="{{ asset('image/board.png') }}" width="30px" height="30px">掲示板</a></p>
