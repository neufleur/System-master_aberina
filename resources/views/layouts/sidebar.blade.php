...
<body class="all_content">
  <div class="d-flex">
    <div class="sidebar">
      @section('sidebar')
      <p><a href="{{ route('top.show') }}"><img src="{{ asset('image/home.png') }}" width="33px" height="33px">トップ</a></p>
      ...
      <p><a href="{{ route('calendar.admin.show',['user_id' => Auth::id()]) }}"><img src="{{ asset('image/booked.png') }}" width="35px" height="35px">スクール予約確認</a></p>
      <p><a href="{{ route('calendar.admin.setting',['user_id' => Auth::id()]) }}"><img src="{{ asset('image/register.png') }}" width="35px" height="35px">スクール枠登録</a></p>
